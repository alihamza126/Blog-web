...
export const LogoIcon = ({ className, ...rest }) => {
  return (
    <svg
      viewBox="71.701 61.377 72.85 83.174"
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      {...rest}
    >
      ...
      <linearGradient
        ...
        y2="0%"
      >
        <stop offset="0" stopColor="#085B20" stopOpacity="1" />
        <stop offset="1" stopColor="#41E296" stopOpacity="1" />
      </linearGradient>
      <g
        id="icon"
        stroke="none"
        fill="url(#gradient)"
        transform="matrix(3.289935, 0, 0, 2.843922, 54.914883, 57.520977)"
      >
